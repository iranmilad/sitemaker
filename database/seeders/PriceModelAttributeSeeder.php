...
class PriceModelAttributeSeeder extends Seeder
{
    public function run()
    {
        Attribute::where('display_type', 'priceModel')->delete();
        // ایجاد متریال مختلف برای ویژگی model
        $models = [
            ['name' => 'داخلی', 'details' => 'داخلی',"price"=>'0',"base_unit" =>"", 'img' => '/images/product/inside.svg'],
            ['name' => 'بیرونی', 'details' => 'بیرونی',"price"=>'24000',"base_unit" =>"", 'img' => '/images/product/outside.svg'],
        ];
