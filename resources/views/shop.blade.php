                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                        <div class="page-title">
                            <h1>خرید نوار کناری سمت چپ</h1>
                        </div>
                        <!--Breadcrumbs-->
                        <div class="breadcrumbs"><a href="index.html" title="بازگشت به صفحه اصلی">صفحه اصلی</a><span
                                class="title"><i class="icon anm anm-angle-left-l"></i>خرید</span><span
                                class="main-title"><i class="icon anm anm-angle-left-l"></i>خرید نوار کناری سمت چپ</span>
                        </div>
                        <!--End Breadcrumbs-->
                    </div>
                </div>
                ...
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection1.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection1.jpg') }}" alt="Men's"
                                title="مردانه" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">مردانه</h4>
                            <p class="counts">20 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection2.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection2.jpg') }}" alt="Women's"
                                title="زنانه" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">زنانه</h4>
                            <p class="counts">24 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection3.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection3.jpg') }}" alt="Top"
                                title="بالا" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">بالا</h4>
                            <p class="counts">13 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection4.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection4.jpg') }}" alt="Bottom"
                                title="پایین" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">پایین</h4>
                            <p class="counts">26 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                ...
                                src="{{ asset('storage/images/collection/sub-collection5.jpg') }}" alt="T-Shirts"
                                title="تی شرت" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">تی شرت</h4>
                            <p class="counts">18 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection6.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection6.jpg') }}" alt="Shirts"
                                title="پیراهن" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">پیراهن</h4>
                            <p class="counts">11 موارد</p>
                        </div>
                    </a>
                </div>
                <div class="category-item zoomscal-hov">
                    <a href="shop-left-sidebar.html" class="category-link clr-none">
                        <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload"
                                data-src="{{ asset('storage/images/collection/sub-collection24.jpg') }}"
                                src="{{ asset('storage/images/collection/sub-collection24.jpg') }}" alt="Jeans"
                                title="شلوار جین" width="365" height="365" /></div>
                        <div class="details text-center">
                            <h4 class="category-title mb-0">شلوار جین</h4>
                            <p class="counts">28 موارد</p>
                        </div>
                    </a>
                </div>
            </div>
                    ...
                    <div class="sidebar-tags sidebar-sticky clearfix">
                        ...
                        <div class="sidebar-widget clearfix categories filterBox filter-widget">
                            ...
                            <div class="widget-content filterDD">
                                <ul class="sidebar-categories scrollspy morelist clearfix">
                                    <li class="lvl1 sub-level more-item"><a href="#;" class="site-nav">لباس</a>
                                        <ul class="sublinks">
                                    ...
                                    <li class="lvl1 sub-level more-item"><a href="#;" class="site-nav">جواهرات</a>
                                        <ul class="sublinks">
                                            ...
                                            <li class="lvl2"><a href="#" class="site-nav">گوشواره <span
                            ...
                            <div class="widget-content filter-color filterDD">
                                <ul class="swacth-list swatches d-flex-center clearfix pt-0">
                                    <li class="swatch large radius available active"><img
                                            src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                    ...
                                    <li class="swatch large radius available"><img
                                            src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                            alt="تصویر" width="70" height="70" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="قرمز" /></li>
                                    ...
                                    <li class="swatch large radius available pink"><span class="swatchLbl"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="صورتی"></span></li>
                                    <li class="swatch large radius available gray"><span class="swatchLbl"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="خاکستری"></span></li>
                        ...
                        <div class="sidebar-widget static-banner p-0">
                            <a href="shop-left-sidebar.html"><img class="rounded-0 blur-up lazyload"
                                    data-src="{{ asset('storage/images/banners/shop-banner.jpg') }}"
                                    src="{{ asset('storage/images/banners/shop-banner.jpg') }}" alt="تصویر"
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- End Product Review -->
                                        <!--Sort Description-->
                                        <p class="sort-desc hidden">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                                            چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در
                                        ...
                                        <ul class="variants-clr swatches">
                                            ...
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="سبز"><img
                                                        src="{{ asset('storage/images/products/product1-1.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="خاکستری"><img
                                                        src="{{ asset('storage/images/products/product1-2.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="نارنجی"><img
                                                        src="{{ asset('storage/images/products/product1-3.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                        </ul>
                                        <!-- End Variant -->
                                        <!-- Product Button -->
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product2-1.jpg') }}"
                                                alt="محصول" title="محصول" width="625" height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                        <!-- End Product Image -->
                                        <!--Product Button-->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <ul class="variants-clr swatches">
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="نیروی دریایی"><img
                                                        src="{{ asset('storage/images/products/product2.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="سبز"><img
                                                        src="{{ asset('storage/images/products/product2-1.jpg') }}"
                                            ...
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="خاکستری"><img
                                                        src="{{ asset('storage/images/products/product2-2.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="نارنجی"><img
                                                        src="{{ asset('storage/images/products/product2-3.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="رنگ زرد"><img
                                                        src="{{ asset('storage/images/products/product2-4.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                            <li class="swatch medium radius"><span class="swatchLbl"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="آبی"><img
                                                        src="{{ asset('storage/images/products/product2-5.jpg') }}"
                                                        alt="تصویر" width="625" height="808"></span></li>
                                        </ul>
                                        <!-- End Variant -->
                                        <!-- Product Button -->
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product3-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625" height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                        <!-- End Product Image -->
                                        <!-- Product label -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product4-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625" height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                        <!-- End Product Image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Product Price -->
                                        <div class="product-price">
                                            <span class="price old-price">198 ichv</span><span class="price">99
                                                هزار</span>
                                        </div>
                                        <!-- End Product Price -->
                                        <!-- Product Review -->
                                        ...
                                        <ul class="variants-clr swatches">
                                            <li class="swatch medium radius black"><img
                                                    src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                                    alt="تصویر" width="70" height="70"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="سیاه" />
                                            </li>
                                            <li class="swatch medium radius navy"><img
                                                    src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                                    alt="تصویر" width="70" height="70"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="دریایی" />
                                            </li>
                                            <li class="swatch medium radius darkgreen"><img
                                                    src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                                    alt="تصویر" width="70" height="70"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="سبز تیره" />
                                            </li>
                                        </ul>
                                        <!-- End Variant -->
                                        <!-- Product Button -->
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product5-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625" height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                        <!-- End Product Image -->
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product6.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                data-src="{{ asset('storage/images/products/product6-1.jpg') }}"
                                                src="{{ asset('storage/images/products/product6-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product7.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product7-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <ul class="variants-clr swatches">
                                            ...
                                            <li class="swatch medium radius maroon"><img
                                                    src="{{ asset('storage/images/products/swatches/blue-red.jpg') }}"
                                                    alt="تصویر" width="70" height="70"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="مارون" />
                                            </li>
                                        </ul>
                                        <!-- End Variant -->
                                        <!-- Product Button -->
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product8.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product8-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product9.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product9-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product10.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product10-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product11.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product11-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product12.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product12-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-review">
                                            <i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                                class="icon anm anm-star"></i><i class="icon anm anm-star-o"></i><i
                                                class="icon anm anm-star-o"></i>
                                            <span class="caption hidden ms-1">6 بررسی</span>
                                        </div>
                                        <!-- End Product Review -->
                                        <!-- Product Button -->
                                        <div class="button-action hidden">
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product13.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product13-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name">
                                            <a href="product-layout1.html">پیراهن کژوال نخی</a>
                                        </div>
                                        <!-- End Product Name -->
                                        <!-- Product Price -->
                                        <div class="product-price">
                                        ...
                                        <div class="product-review">
                                            <i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                                class="icon anm anm-star-o"></i><i class="icon anm anm-star-o"></i><i
                                                class="icon anm anm-star-o"></i>
                                            <span class="caption hidden ms-1">13 بررسی</span>
                                        </div>
                                        <!-- End Product Review -->
                                        <!-- Product Button -->
                                        <div class="button-action hidden">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product14.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product14-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-review">
                                            <i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                                class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                                class="icon anm anm-star-o"></i>
                                            <span class="caption hidden ms-1">20 بررسی</span>
                                        </div>
                                        <!-- End Product Review -->
                                        <!-- Product Button -->
                                        <div class="button-action hidden">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout1.html" class="product-img rounded-0">
                                            ...
                                            <img class="primary rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product15.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Image -->
                                            <!-- Hover Image -->
                                            <img class="hover rounded-0 blur-up lazyload"
                                                ...
                                                src="{{ asset('storage/images/products/product15-1.jpg') }}"
                                                alt="محصول" title="تولید - محصول" width="625"
                                                height="808" />
                                            <!-- End Hover Image -->
                                        </a>
