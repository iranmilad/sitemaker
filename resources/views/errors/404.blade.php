@extends('layouts.app')
@section('title', 'این صفحه وجود ندارد')
@section('body', 'error-404-page')
            ...
            <div class="row">
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
                    <div class="error-content py-4">
                        ...
                        <h2 class="fs-4 mt-4">اوه! صفحه ای که درخواست کردید پیدا نشد!</h2>
                        <p class="mb-4">صفحه مورد نظر منتقل شده، حذف شده، تغییر نام داده شده است یا ممکن است هرگز وجود
                            نداشته باشد.</p>
                        <form class="search-404 mb-4" id="404search" action="#" method="get">
                            <div class="input-group">
                                <input type="text" class="form-control input-group-field" name="search"
                                    value="" placeholder="چگونه می توانیم کمک کنیم؟" required />
