    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="logo col-4 col-sm-4 col-md-4 col-lg-1 col-xxl-1 align-self-center">
                <a class="logoImg" href="index.html"><img src="{{ asset('storage/images/logo-tools.png')}}" alt="قالب  چند منظوره هما" title="قالب  چند منظوره هما" width="149" height="39" /></a>
            </div>
            <!--End Logo-->
           <!--منو-->
                            ...
                            <ul class="row grid--uniform mmWrapper">
                                ...
                                <li class="lvl-1 col-md-3 col-lg-3 w-34 banner-col">
                                    <div class="banner-wrap">
                                        <a href="shop-left-sidebar.html"><img class="blur-up lazyload" data-src="{{ asset('storage/images/megamenu/demo5-banner-menu.jpg')}}" src="{{ asset('storage/images/megamenu/demo5-banner-menu.jpg')}}" alt="بنر" width="500" height="600" /></a>
                                    ...
                                    <div class="grid-products weekly-product gp10 mt-1">
                                        <div class="item">
                                            <div class="product-wrap position-relative">
                                                ...
                                                <div class="product-image mb-0">
                                                    <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools1.jpg')}}" src="{{ asset('storage/images/products/tools1.jpg')}}" alt="محصول" title="محصول" width="625" height="781" /></a>
                                                    <div class="product-labels"><span class="lbl on-sale">فروش</span></div>
                                                </div>
                                                <!-- تصویر محصول نهایی -->
                                                <!-- شروع جزئیات محصول -->
                                                <div class="product-details text-center">
                                                    <div class="product-name"><a href="product-layout1.html">ابزار Plasterer</a></div>
                                        ...
                                        <div class="item">
                                            <div class="product-wrap position-relative"><!-- شروع تصویر محصول -->
                                                <div class="product-image mb-0">
                                                    <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools2.jpg')}}" src="{{ asset('storage/images/products/tools2.jpg')}}" alt="محصول" title="محصول" width="625" height="781" /></a>
                                                </div>
                                                <!-- تصویر محصول نهایی -->
                                                <!-- شروع جزئیات محصول -->
                                                <div class="product-details text-center">
                                                    <div class="product-name"><a href="product-layout1.html">ابزار چکش</a></div>
                                                    <div class="product-price">
                                        ...
                                        <div class="item">
                                            <div class="product-wrap position-relative">
                                                <!-- شروع تصویر محصول -->
                                                <div class="product-image mb-0">
                                                    <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools3.jpg')}}" src="{{ asset('storage/images/products/tools3.jpg')}}" alt="محصول" title="محصول" width="625" height="781" /></a>
                                                </div>
                                                <!-- تصویر محصول نهایی -->
                                                <!-- شروع جزئیات محصول -->
                                                <div class="product-details text-center">
                                                    <div class="product-name"><a href="product-layout1.html">ابزار دستی هواپیما</a></div>
                                                    <div class="product-price">
                        ...
                        <form class="form minisearch search-inline-brd" id="header-search0" action="#" method="get">
                            ...
                            <div class="d-flex searchField">
                                ...
                                <div class="input-box d-flex fl-1">
                                    <input type="text" class="form-control input-group-field search-input border-0" placeholder="در اینجا جستجو کنید..." value="" />
                                        ...
                                        <ul class="items g-2 g-md-3 row row-cols-lg-4 row-cols-md-3 row-cols-sm-2">
                                            ...
                                            <li class="item">
                                                <div class="mini-list-item d-flex align-items-center w-100 clearfix">
                                                    <div class="mini-image text-center"><a class="item-link" href="product-layout1.html"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools1-120x170.jpg')}}" src="{{ asset('storage/images/products/tools1-120x170.jpg')}}" alt="تصویر" title="محصول" width="120" height="170" /></a> </div>
                                                    <div class="ms-3 details text-right">
                                                        <div class="product-name"><a class="item-title" href="product-layout1.html">ابزار Plasterer</a></div>
                                                        <div class="product-price"><span class="old-price">114.00$</span><span class="price">99.00$</span></div><div class="product-review d-flex align-items-center justify-content-start">
                                                            <i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i class="icon anm anm-star-o"></i><i class="icon anm anm-star-o"></i>
                                            ...
                                            <li class="item">
                                                <div class="mini-list-item d-flex align-items-center w-100 clearfix">
                                                    <div class="mini-image text-center"><a class="item-link" href="product-layout1.html"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools2-120x170.jpg')}}" src="{{ asset('storage/images/products/tools2-120x170.jpg')}}" alt="تصویر" title="محصول" width="120" height="170" /></a> </div>
                                                    <div class="ms-3 details text-right">
                                                        <div class="product-name"><a class="item-title" href="product-layout1.html">ابزار چکش</a></div>
                                            ...
                                            <li class="item">
                                                <div class="mini-list-item d-flex align-items-center w-100 clearfix">
                                                    <div class="mini-image text-center"><a class="item-link" href="product-layout1.html"><img class="blur-up lazyload" data-src="{{ asset('storage/images/products/tools3-120x170.jpg')}}" src="{{ asset('storage/images/products/tools3-120x170.jpg')}}" alt="تصویر" title="محصول" width="120" height="170" /></a> </div>
                                                    <div class="ms-3 details text-right">
                                                        <div class="product-name"><a class="item-title" href="product-layout1.html">ابزار دستی هواپیما</a></div>
