            ...
            <div class="row">
                ...
                <div class="col-4 col-sm-4 col-md-5 col-lg-5 col-xxl-5 align-self-center icons-col text-left">
                    ...
                    <div class="header-cart iconset" title="Cart">
                        <a href="#;" class="header-cart btn-minicart clr-none" data-bs-toggle="offcanvas" data-bs-target="#minicart-drawer"><i class="hdr-icon icon anm anm-cart-l"></i><span class="cart-count">{{$cartCount}}</span></a>
                    </div>
                    <!--End Minicart-->
                </div>
                <!--End Right Icon-->
