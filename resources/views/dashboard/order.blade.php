            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9">
                    <div class="dashboard-content tab-content h-100" id="top-tabContent">
                        ...
                        <!-- Orders tracking -->
                        <div class="tab-pane fade h-100 show active" id="orderstracking">
                            <div class="orders-card mt-0 h-100">
                                ...
                                <div class="row mt-2">
                                    <div class="col-sm-12">
                                        <h3>وضعیت سفارش شماره: {{ $basket->cart->id }}</h3>
                                        <!-- ترتیب وضعیت -->
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-8">
                                                <div class="tracking-detail d-flex-center">
                                                    <ul>
                                                        <li>
                                                            <div class="left"><span>تعداد مرسوله </span></div>
                                                            <div class="right"><span>{{ $order->basket()->cart->count }}</span></div>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <div class="left"><span> هزینه ارسال (تومان) </span></div>
                                                            <div class="right"><span>{{  $order->basket()->cart->deliveryCost }}</span></div>
                                                        </li>
                                                        <li>
                                                            <div class="left"><span>آدرس حمل و نقل</span></div>
                                                            <div class="right"><span>ایران {{ $order->shipping_province }} {{ $order->shipping_city }}   {{ $order->shipping_address }} کد پستی {{ $order->shipping_postal_code }}</span></div>
                                                        </li>
                                                        <li>
                                                            <div class="left"><span> مبلغ مرسوله (تومان)</span></div>
                                                            <div class="right"><span>{{  $order->basket()->cart->total }}</span></div>
                                                        </li>
                                                        <li>
                                                            <div class="left"><span>مبلغ قابل پرداخت (تومان)</span>
                                                            </div>
                                                            <div class="right"><span>{{  $order->basket()->cart->totalPayed }}</span></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tracking-steps nav mt-5 mb-4 clearfix">
                                            <div class="step {{ ($basket->cart->orderStatus=="rejected") ? 'current' :'done' }}"><span>لغو شد</span></div>
                                            <div class="step {{ ($basket->cart->orderStatus=="pending") ? 'current' :'done' }}"><span>در انتظار</span></div>
                                            <div class="step {{ ($basket->cart->orderStatus=="processing") ? 'current' :'done' }}"><span>آماده شدن برای ارسال</span></div>
                                            <div class="step {{ ($basket->cart->orderStatus=="compeleted") ? 'current' :'done' }}"><span>ارسال شد</span></div>
                                        </div>
                                        <!-- پایان مراحل پیگیری -->
                                        <!-- جدول سفارش -->
                                            ...
                                            <table class="table align-middle text-center order-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($basket->items as $item)
                                                        ...
                                                        <tr>
                                                            <td><a href="{{ $item->link }}"><img src="{{ $item->img }}" alt="" width="50" height="50"></a></td>
                                                            <td>{{ $item->name }}</td>
                                                            <td>
