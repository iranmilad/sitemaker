                            ...
                            <form method="post" action="#" class="customer-form">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12 mb-4">
                                        <label for="CustomerEmail" class="d-none">ایمیل خود را وارد کنید <span
                                                class="required">*</span></label>
                                        <input type="email" name="customer[email]" placeholder="ایمیل خود را وارد کنید"
                                    ...
                                    <div class="form-group col-12 mb-0">
                                        <div
                                            ...
                                            <a href="login.html" class="d-flex-justify-center btn-link">بازگشت به ورود<i
